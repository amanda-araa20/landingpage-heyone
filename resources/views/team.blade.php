...
<head>
    <meta charset="utf-8">
    <title>Poseify - Our Models</title>
                ...
                <div class="navbar-nav mx-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="{{ url('team') }}" class="dropdown-item active">Our Models</a>
        ...
        <div class="container py-5">
            <div class="text-center">
                <div class="title wow fadeInUp" data-wow-delay="0.1s">
                    <div class="title-center">
                        <h5>Our Team</h5>
                        <h1>Meet Our Professional Models</h1>
                    </div>
                </div>
            </div>
            <div class="row g-4 justify-content-center">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item text-center p-4">
                        <div class="team-img position-relative">
                            <img class="img-fluid rounded-circle mb-3" src="{{ asset('img/team-1.jpg') }}" alt="">
                            <div class="team-social position-absolute top-50 start-50 translate-middle d-flex">
                        ...
                        <span class="text-primary">Fashion Model</span>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item text-center p-4">
                        <div class="team-img position-relative">
                            <img class="img-fluid rounded-circle mb-3" src="{{ asset('img/team-2.jpg') }}" alt="">
                            <div class="team-social position-absolute top-50 start-50 translate-middle d-flex">
                                <a class="btn btn-square btn-primary mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-primary mx-1" href="#"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square btn-primary mx-1" href="#"><i class="fab fa-instagram"></i></a>
                        ...
                        <h5 class="text-uppercase">James Parker</h5>
                        <span class="text-primary">Commercial Model</span>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item text-center p-4">
                        <div class="team-img position-relative">
                            <img class="img-fluid rounded-circle mb-3" src="{{ asset('img/team-3.jpg') }}" alt="">
                            <div class="team-social position-absolute top-50 start-50 translate-middle d-flex">
                                <a class="btn btn-square btn-primary mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-primary mx-1" href="#"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square btn-primary mx-1" href="#"><i class="fab fa-instagram"></i></a>
                        ...
                        <h5 class="text-uppercase">Emily Davis</h5>
                        <span class="text-primary">Event Model</span>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item text-center p-4">
                        <div class="team-img position-relative">
                            <img class="img-fluid rounded-circle mb-3" src="{{ asset('img/team-4.jpg') }}" alt="">
                            <div class="team-social position-absolute top-50 start-50 translate-middle d-flex">
                                <a class="btn btn-square btn-primary mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-primary mx-1" href="#"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square btn-primary mx-1" href="#"><i class="fab fa-instagram"></i></a>
                        ...
                        <span class="text-primary">Professional Model</span>
                    </div>
                </div>
            </div>
        </div>
