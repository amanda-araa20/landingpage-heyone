...
<head>
    <meta charset="utf-8">
    <title>HeiVet - Solusi Digital untuk Klinik Hewan Anda</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="HeiVet, klinik hewan, pet clinic, veterinary, CAATIS" name="keywords">
        ...
        <div class="container-fluid">
            <a href="#home" class="navbar-brand ms-4 ms-lg-0">
                <h2 class="mb-0 text-primary text-uppercase">
                    <i class="fas fa-paw me-2"></i>HeiVet
                </h2>
            </a>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset('assets/img/carousel-1.jpg') }}" alt="HeiVet Hero">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="title mx-2 mx-md-5 px-2 px-md-5 animated slideInDown">
                            <div class="title-center">
                                <h5 class="text-white">Welcome to HeiVet</h5>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('assets/img/carousel-2.jpg') }}" alt="HeiVet Features">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="title mx-2 mx-md-5 px-2 px-md-5 animated slideInDown">
                            <div class="title-center">
                        ...
                        <p class="fs-5 mb-5 text-white animated slideInDown px-3">
                            Bergabunglah dengan klinik-klinik terpercaya yang telah menggunakan HeiVet.<br class="d-none d-md-inline">
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-7 pb-0 pb-lg-5">
                    <div class="pb-0 pb-lg-5">
                        ...
                        <p class="mb-4 wow fadeInUp" data-wow-delay="0.2s" style="font-size: 18px; color: #555; line-height: 1.6; margin-bottom: 40px; text-align: justify;">
                          <strong style="color: #00596d;">HeiVet</strong> adalah platform digital yang membantu klinik hewan, dokter,
                          dan pemilik hewan peliharaan dalam mencatat data kesehatan hewan, memantau jadwal perawatan,
                          serta mengelola informasi pemilik dan pasien dengan mudah. HeiVet memiliki total
                           ...
                           kebutuhan kesehatan hewan peliharaan Anda. HeiVet juga sudah memiliki total <strong style="color: #00596d;">{{ $totalCustomers }} pengguna</strong> terdaftar dan
                           <strong style="color: #00596d;">{{ $totalPets }} hewan peliharaan</strong> yang telah ditangani dengan penuh kasih sayang. Dari sisi klinik, HeiVet memberikan solusi lengkap untuk manajemen data pelanggan, jadwal praktek dokter, 
                ...
                <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.6s">
                    <img class="img-fluid rounded" src="{{ asset('assets/img/about.png') }}" alt="About HeiVet">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container py-5">
            ...
            <div class="text-center mb-5">
                <div class="title wow fadeInUp" data-wow-delay="0.1s">
                    <div class="title-center">
                        <h5>Our Fiture</h5>
                        <h1>Fitur Utama HeiVet</h1>
                    </div>
                </div>
                <p class="text-muted">
                    Fitur-Fitur yang disediakan oleh HeiVet demi kenyamanan Anda
                </p>
            </div>
                    ...
                    <div class="col-lg-9">
                        <div class="service-text px-5 px-lg-0 py-lg-5 wow fadeInRight" data-wow-delay="0.5s">
                            ...
                            <p class="feature-desc mb-0">
                                HeiVet membantu klinik menyimpan data pemilik hewan dan hewan peliharaan dalam satu profil terstruktur,
                ...
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-md-9">
                        <div class="service-text px-5 px-lg-0 py-lg-5 text-lg-end wow fadeInLeft" data-wow-delay="0.5s">
                            ...
                            <p class="feature-desc mb-0">
                                HeiVet mendukung banyak cabang klinik dalam satu sistem terpusat, sehingga pemilik usaha dapat
        ...
        <div class="container py-5">
            <!-- <div class="text-center mb-5">
                <div class="title wow fadeInUp" data-wow-delay="0.1s">
                    <div class="title-center">
                        <h5>Our Partners</h5>
                        <h1>Klinik yang Menggunakan HeiVet</h1>
                    </div>
                </div>
                <p class="text-muted">Temukan klinik hewan terpercaya di dekat Anda yang telah menggunakan HeiVet</p>
            </div> -->
        ...
        <div class="container-fluid about-caatis py-5">
            <div class="container py-5">
                ...
                <div class="row g-4 align-items-center"> -->
                    ...
                    <!-- Deskripsi CAATIS -->
                    <!-- <div class="col-lg-7">
                        <h1 class="display-5 mb-3" style="color: #01aed6;">CAATIS sebagai Rumah Inovasi HeiVet</h1>
                ...
                <div class="text-center mb-5">
                    <div class="title white wow fadeInUp" data-wow-delay="0.1s">
                        <div class="title-center">
                            ...
                            <h1 class="text-white">Paket HeiVet untuk Klinik Hewan</h1>
                        </div>
                    </div>
...
<section id="cta-buttons" class="py-5" style="background: #f0fbff;">
    <div class="container py-3">
        <div class="text-center mb-4 wow fadeInUp" data-wow-delay="0.1s">
            <h2 style="color: #01aed6;">Mulai Gunakan HeiVet Sekarang</h2>
...
<!-- CTA Buttons Section End -->
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="title">
                        <div class="title-left">
                            <h5>Contact Us</h5>
                            <h1>Tertarik Menggunakan HeiVet?</h1>
                        </div>
                    </div>
    ...
    <footer class="footer py-5">
        <div class="container text-center py-5">
            ...
            <p class="text-white-50 mb-2">&copy; 2024 HeiVet. All Rights Reserved.</p>
