...
<head>
    <meta charset="utf-8">
    <title>{{ config('app.name', 'Poseify') }} - Page Not Found</title>
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-lg-5">
            <a href="{{ url('/') }}" class="navbar-brand ms-4 ms-lg-0">
                <h2 class="mb-0 text-primary text-uppercase">
                    <i class="fa-regular fa-face-smile me-1"></i>{{ config('app.name', 'Poseify') }}
                </h2>
            </a>
    ...
    <div class="container-fluid bg-dark text-light footer py-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            ...
            <p>&copy; <a class="border-bottom" href="#">{{ config('app.name', 'Poseify') }}</a>, All Right Reserved.</p>
            <p class="mb-0">
