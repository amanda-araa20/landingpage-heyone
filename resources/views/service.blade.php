...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            {{-- Service Items --}}
            @foreach([
                ['img' => 'img/service-1.jpg', 'title' => 'Fashion Shows', 'align' => 'left'],
                ['img' => 'img/service-2.jpg', 'title' => 'Corporate Events', 'align' => 'right'],
                ['img' => 'img/service-3.jpg', 'title' => 'Commercial Photo Shots', 'align' => 'left'],
                ['img' => 'img/service-4.jpg', 'title' => 'Professional Modeling', 'align' => 'right'],
            ] as $service)
                <div class="service-item service-item-{{ $service['align'] }}">
                    <div class="row g-0 align-items-center">
                        @if($service['align'] == 'left')
                            <div class="col-md-5">
                                <div class="service-img p-5 wow fadeInRight" data-wow-delay="0.2s">
                                    <img class="img-fluid rounded-circle" src="{{ asset($service['img']) }}" alt="">
                                </div>
                            </div>
                        @endif
                        <div class="col-md-7">
                            <div class="service-text px-5 px-md-0 py-md-5 wow fadeInRight" data-wow-delay="0.5s">
                                ...
                                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam feugiat fermentum urna, sed gravida enim eleifend vitae.</p>
                                <a class="btn btn-outline-primary border-2 px-4" href="#!">Read More <i class="fa fa-arrow-right ms-1"></i></a>
                            </div>
                        </div>
                        @if($service['align'] == 'right')
    ...
    <div class="container-fluid py-5 bg-secondary">
        <div class="container py-5">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.3s">
                @foreach([
                    ['img'=>'img/testimonial-1.jpg','name'=>'Joanne Irwin'],
                    ['img'=>'img/testimonial-2.jpg','name'=>'Lana Anderson'],
                    ['img'=>'img/testimonial-3.jpg','name'=>'Pamela Torney']
                ] as $client)
                <div class="testimonial-item text-center" data-dot="<img class='img-fluid' src='{{ asset($client['img']) }}' alt=''>">
                    <p class="fs-5">Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna ut diam sit et amet stet eos.</p>
